...
import 'comapny registration.dart';
import 'menusample.dart';
import 'models/LoginModel.dart';
import 'models/ProfileModel.dart';

class companyregistersignin extends StatefulWidget {
  const companyregistersignin({super.key});

  @override
  State<companyregistersignin> createState() => _companyregistersigninState();
}

class _companyregistersigninState extends State<companyregistersignin> {
  bool islogin = false;
