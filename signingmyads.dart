...
class signinmyads extends StatefulWidget {
  const signinmyads({super.key});

  @override
  State<signinmyads> createState() => _signinmyadsState();
}

class _signinmyadsState extends State<signinmyads> {
  bool islogin = false;
    ...
    checkLoggedInStatus().then((isLoggedIn) {
      if (isLoggedIn) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) =>MyAdsList('1')),
        );
      }
    });
  }
