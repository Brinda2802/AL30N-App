...
import 'Mysearches.dart';
import 'menusample.dart';
import 'models/LoginModel.dart';
import 'models/ProfileModel.dart';

class Mysearchsigninpage extends StatefulWidget {
  const Mysearchsigninpage({super.key});

  @override
  State<Mysearchsigninpage> createState() => _MysearchsigninpageState();
}

class _MysearchsigninpageState extends State<Mysearchsigninpage> {
  bool islogin = false;
    ...
    checkLoggedInStatus().then((isLoggedIn) {
      if (isLoggedIn) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) =>Mysearches()),
        );
      }
    });
  }
